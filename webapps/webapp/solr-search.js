...
var bkComplete = null;
var flstring = "fl=id,url,title,product,release,booktitle";
...
window.onload = function(){
    ...
    initURL = "http://localhost:8983/solr/corehw/query";//+flstring;    
...
function MakeUrl(baseurl,q,cursorMark,facet,fq1,fq2,fq3){
    ...
    var url = baseurl+"q="+q+"&cursorMark="+cursorMark+"&facet="+facet; //+"&"+flstring;
    if(fq1 != null){
